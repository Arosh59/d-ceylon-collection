...
- Confirm editorial roles and public-read fields, media licences, retention policy, staff MFA,
  payment-provider webhook secrets, and AI gateway shared-secret rotation.
